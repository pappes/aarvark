...
main() {
  ...
  //     'console.log("calculate 1+2 = " + (1+2));'); //writes to the console 'calculate 1+2 = 3'
  ...
  print(new Element.html('<iframe src="www.google.com"></iframe>')
      .outerHtml); //prints '<iframe></iframe>')
}
